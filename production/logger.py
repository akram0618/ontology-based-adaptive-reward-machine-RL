...
def export_statistics_logging(statistics, parameters, resources):
    ...
    ce.printLog("##########################")
    ce.printLog("Tardiness orders:",statistics['stat_order_tardiness'])
    ce.printLog("Average waiting time of orders:", statistics['stat_total_waiting_time_orders']/len(statistics['orders_done']))
    ce.printLog("Total waiting time of orders:", statistics['stat_total_waiting_time_orders'])
    #low priority
    ce.printLog("Average waiting time of low orders:",
                statistics['stat_total_waiting_time_orders_low'] / statistics['ORDER_PRIORITY_LOW'])
    ce.printLog("Total waiting time of low orders:", statistics['stat_total_waiting_time_orders_low'])
    # medium priority
    ce.printLog("Average waiting time of medium orders:",
                statistics['stat_total_waiting_time_orders_medium'] / statistics['ORDER_PRIORITY_MED'])
    ce.printLog("Total waiting time of medium orders:", statistics['stat_total_waiting_time_orders_medium'])
    # high priority
    ce.printLog("Average waiting time of high orders:",
                statistics['stat_total_waiting_time_orders_high'] / statistics['ORDER_PRIORITY_HIGH'])
    ce.printLog("Total waiting time of high orders:", statistics['stat_total_waiting_time_orders_high'])
